            ...
            setMessages([
                {
                    ...
                    options: [
                        ...
                        { label: 'About OryFolks', action: 'about' }
                    ]
                }
            ]);
        }
            ...
            switch (action) {
                case 'services':
                    response = {
                        id: Date.now().toString(),
                        sender: 'bot',
                        text: 'Our main service areas:\n\n• BOT Vision — long-term dedicated bilingual engineering teams\n• IT Staffing — flexible contract and staffing solutions\n• Full Cycle Development — end-to-end product and AI development\n\nWould you like to open the Services page?',
                        options: [
                ...
                case 'contact':
                    response = {
                        id: Date.now().toString(),
                        sender: 'bot',
                        text: 'Contact OryFolks:\n\nIndia Office:\nPlot No. 25/11/23, Savithri Nagar 3rd street, Vedayapalem, Nellore 524004\nPhone: +91 0861-4500024\n\nJapan Office:\nHigashi Azabu K building 3F, 3-4-17 Higashi Azabu Minato-ku, Tokyo, Japan 106-0044\nPhone: +81-50-1706-3337\n\nEmail: info@oryfolks.com\n\nWould you like to open the Contact page?',
                        options: [
                ...
                case 'careers':
                    ...
                    response = {
                        id: Date.now().toString(),
                        sender: 'bot',
                        text: `We are always looking for top talent!\nNavigate to our careers page to see current openings.`,
                        options: [
                ...
                case 'about':
                    response = {
                        ...
                        text: aboutData?.companyInfo 
                            ? `OryFolks: ${aboutData.companyInfo.description.charAt(0).toUpperCase() + aboutData.companyInfo.description.slice(1)}\n\nWould you like to learn more about us?`
                            : 'OryFolks bridges Japan and India through language services, engineering, and staffing solutions. Would you like to learn more about us?',
                        options: [
    ...
    const generateResponse = (input: string): ChatMessage => {
        ...
        if (lowerInput.includes('service') || lowerInput.includes('offer')) {
            return {
                id: Date.now().toString(),
                sender: 'bot',
                text: 'We provide engineering solutions, IT staffing, and full-cycle development. Would you like to see the Services page?',
        ...
        if (lowerInput.includes('job') || lowerInput.includes('career') || lowerInput.includes('work') || lowerInput.includes('hiring')) {
            return {
                id: Date.now().toString(),
                sender: 'bot',
                text: 'Yes, OryFolks is hiring. Please check our Careers page for open positions and application details.',
        ...
        if (lowerInput.includes('about') || lowerInput.includes('who') || lowerInput.includes('company')) {
            return {
                id: Date.now().toString(),
                sender: 'bot',
                text: 'OryFolks bridges Japan and India with language services, engineering, and staffing. Would you like to learn more?',
        ...
        return {
            id: Date.now().toString(),
            sender: 'bot',
            text: "I'm the OryFolks assistant. How can I help you navigate the site?",
            options: [
                { label: 'Our Services', action: 'services' },
                { label: 'Contact Us', action: 'contact' },
                { label: 'Careers', action: 'careers' },
        ...
        <>
            ...
            >
                ...
                <div className="p-4 bg-gradient-to-r from-blue-600 to-purple-600 flex items-center gap-3 shadow-md">
                    ...
                    <div>
                        <h3 className="text-white font-bold text-lg">OryFolks Assistant</h3>
