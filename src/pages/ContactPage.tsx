            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-gray-600 text-sm">+91 0861-4500024</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Phone className="text-primary-600" size={18} />
                    <span className="text-gray-600 text-sm">+65 81198492</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Phone className="text-primary-600" size={18} />
                    <span className="text-gray-600 text-sm">+81-50-1706-3337</span>
                  </div>
                </div>
              </div>
